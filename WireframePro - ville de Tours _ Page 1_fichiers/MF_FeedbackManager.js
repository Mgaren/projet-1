...
(function() {
if (dwr.engine._getObject("MF_FeedbackManager") == undefined) {
var p;
...
p.listByPage = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'listByPage', arguments);
};
...
p.listByPage = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'listByPage', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'contactCustomerSupport', arguments);
};
...
p.countComments = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'countComments', arguments);
};
...
p.updatePageCommentCount = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'updatePageCommentCount', arguments);
};
...
p.deleteFeedback = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'deleteFeedback', arguments);
};
...
p.updateFeedback = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'updateFeedback', arguments);
};
...
p.uploadAttachment = function(p0, p1, p2, p3, p4, p5, p6, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'uploadAttachment', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'create', arguments);
};
...
p.create = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_FeedbackManager', 'create', arguments);
};

dwr.engine._setObject("MF_FeedbackManager", p);
}
})();
