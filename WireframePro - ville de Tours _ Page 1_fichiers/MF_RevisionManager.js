...
(function() {
if (dwr.engine._getObject("MF_RevisionManager") == undefined) {
var p;
...
p.checkInAutoSavedRevision = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'checkInAutoSavedRevision', arguments);
};
...
p.checkInAutoSavedRevision = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'checkInAutoSavedRevision', arguments);
};
...
p.createFromRevision = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'createFromRevision', arguments);
};
...
p.changeRevisionNote = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'changeRevisionNote', arguments);
};
...
p.checkOutRevision = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'checkOutRevision', arguments);
};
...
p.checkInRevision = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'checkInRevision', arguments);
};
...
p.checkInRevision = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'checkInRevision', arguments);
};
...
p.deleteRevision = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'deleteRevision', arguments);
};
...
p.list = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'list', arguments);
};
...
p.list = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_RevisionManager', 'list', arguments);
};

dwr.engine._setObject("MF_RevisionManager", p);
}
})();
