...
(function() {
if (dwr.engine._getObject("MF_FontManager") == undefined) {
var p;
...
p.getCustomFont = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FontManager', 'getCustomFont', arguments);
};
...
p.copyCustomFont = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FontManager', 'copyCustomFont', arguments);
};
...
p.copyCustomFont = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_FontManager', 'copyCustomFont', arguments);
};
...
p.listCustomFonts = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FontManager', 'listCustomFonts', arguments);
};
...
p.deleteCustomFont = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_FontManager', 'deleteCustomFont', arguments);
};
...
p.uploadFont = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_FontManager', 'uploadFont', arguments);
};

dwr.engine._setObject("MF_FontManager", p);
}
})();
